...
CREATE DATABASE uvv;
CREATE USER deernose WITH ENCRYPTED PASSWORD '1234';
GRANT ALL PRIVILEGES ON DATABASE uvv TO deernose;
\! echo '...'
----------------------------------------------------------------------------------
--
--
...
--
\! echo 'CRIANDO HISTORICO DE CARGOS'
-- CRIAR HISTORICO DE CARGOS
...
\! echo 'DELETANDO CONSTRAINT "empregados_departamentos_fk"'
    ALTER TABLE departamentos DROP CONSTRAINT empregados_departamentos_fk;


\! echo '>INFORMAÇÕES REGIOES'
-- >>>>>INSERINDO INFO
...
\! echo '>INFORMAÇÕES DEPARTAMENTOS'
-- >>>>>INSERINDO INFO
...
-- >>>>>
\! echo 'CONSTRAINTS DEPARTAMENTOS'
...
\! echo '>INFORMAÇÕES HISTORICO DE CARGOS'
-- >>>>>INSERINDO INFO
...
-- >>>>>
\! echo 'CONSTRAINTS HISTORICO DE CARGOS'
...
\! echo 'RE-CRIANDO CONSTRAINT "empregados_departamentos_fk"'
    ALTER TABLE departamentos ADD CONSTRAINT empregados_departamentos_fk
    FOREIGN KEY (id_gerente)
    REFERENCES empregados (id_empregado)
    ON DELETE NO ACTION
